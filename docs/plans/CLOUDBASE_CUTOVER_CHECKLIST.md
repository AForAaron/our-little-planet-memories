...
- [x] 默认域名 Origin / Cookie / 同源写已测（020）；2026-07-31 观察期写矩阵复测全绿（见 `OBSERVATION_QA_LOG.md`）
...
- [x] 追评 / 贴画 revision（2026-07-31：`observation-qa` W2/W3/W7 + 双人 C1–C3；浏览器目视/双开竞态仍建议补做）
- [x] 媒体签名可读；未授权不可读
- [x] 高德 geocode 搜索
- [ ] 冷启动计时 ______ s（35 分钟观察未缩 0；2026-07-31 仍未测到缩 0）
- [x] 热启动计时 ~165–284 ms（2026-07-31 本机热路径约 39–215 ms）
- [ ] 网络环境 / 多设备（人工）
